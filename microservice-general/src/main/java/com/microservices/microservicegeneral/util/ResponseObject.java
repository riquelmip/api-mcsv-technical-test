package com.microservices.microservicegeneral.util;
...
public final class ResponseObject {
    ...
    // Método estático para retornar un ResponseEntity<ResponseObject>
    ...
    public ResponseEntity<ResponseObject> toResponseEntity() {
        // El código ya está definido en la variable 'status'
        HttpStatus code = (status != null) ? status : HttpStatus.OK; // Usa el status si no es null, o por defecto OK

        // Devuelve el ResponseEntity con el código de estado correcto
